...
Before I explored my data further, I decided it was time to make the split between 
...
I chose to put 80% of the data into the training set and left the remaining 20% for the test set. The training set will be used to train all of the machine learning algorithms. It is necessary to keep a separate testing set to see how well a model performs on data that it has never seen before. The test set will only be used to check how well my best model. Until then, I will have no interaction with the test set to ensure model integrity. This means all of my initial exploring will be done on the training set.
