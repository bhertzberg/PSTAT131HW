...
The last thing standing between me and model training is splitting the data. I set my random seed to be able to reproduce the same split in the future, and divided my data in what is called the initial split.
